...
.onCreate(async (snapshot, context) =>
{
    ...
    function sendNotification(androidNotificationToken, activityFeedItem)
    {
        ...
        {
            case "comment":
                body = `${activityFeedItem.username} yorum bıraktı: ${activityFeedItem.commentData}`;
                break;

            case "like":
                body = `${activityFeedItem.username} gönderini beğendi.`;
                break;

            case "follow":
                body = `${activityFeedItem.username} seni takip etti.`;
                break;
